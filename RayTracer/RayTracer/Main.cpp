...
void AddTestObjectsToWorld(RayTracer::RayTracer& tracer)
{
	...
	RayTracer::Vector p9(-2.5, 2.5, -5);
	RayTracer::Vector p10(2.5, 2.5, -10);
	RayTracer::Vector p11(-2.5, -2.5, -5);
	RayTracer::Vector p12(2.5, -2.5, -10);
	COLORREF backgroundPlaneColor2 = RGB(0, 0, 0);
	RayTracer::RectangularPlane *plane3 = new RayTracer::RectangularPlane(p9, p10, p11, p12, backgroundPlaneColor2, 1.f, 1.f, 0.9f);
	...
	RayTracer::Sphere *sp = new RayTracer::Sphere(RayTracer::Vector(3, 0, -8), 1.5f, RGB(0, 0, 0xff), 0.55f, 1.f, 0);
	tracer.AddSphere(sp);
	
	RayTracer::Sphere *sp2 = new RayTracer::Sphere(RayTracer::Vector(0.0f, 0, -8.f), 3.f, RGB(0, 0, 0xff), 1.f, 1.f, 0);
	//tracer.AddSphere(sp2);
	
	RayTracer::Sphere *sp3 = new RayTracer::Sphere(RayTracer::Vector(3.0f, 0, -4.f), 1.5f, RGB(0, 0, 0xff), 0.25f, 1.f, 0);
	...
	RayTracer::LightSource *pointlight = new RayTracer::LightSource(RayTracer::Vector(0, 0, -1));
